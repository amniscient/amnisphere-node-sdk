...
A full reference for this library is available [here](https://github.com/amniscient/amnisphere-node-sdk/blob/HEAD/./reference.md).
...
```typescript
const { data, rawResponse } = await client.loadModel(...).withRawResponse();
